...
private enum SGBoolSetting: String {
    ...
    // MARK: Swiftgram — ghost mode
    case ghostMode
    case ghostModeLocked
    case ghostModeSendReadMessages
    case ghostModeSendReadStories
    case ghostModeSendOnlinePackets
    case ghostModeSendUploadProgress
    case ghostModeSendOfflinePacketAfterOnline
    case ghostModeMarkReadAfterAction
    case ghostModeUseScheduledMessages
    case ghostModeSuggestBeforeStory
    case spyMessageRead
    case spyMessageContentsRead
...
//    case allChatsFolderPositionOverride
    ...
    case ghostModeSendWithoutSound
}
...
//    entries.append(.oneFromManySelector(id: id.count, section: .folders, settingName: .allChatsFolderPositionOverride, text: i18n("Settings.Folders.AllChatsPlacement", lang), value: i18n("Settings.Folders.AllChatsPlacement.\(SGSimpleSettings.shared.allChatsFolderPositionOverride)", lang), enabled: true))
    ...
    entries.append(.header(id: id.count, section: .ghostMode, text: i18n("Settings.GhostMode.Header", lang), badge: newStr))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostMode, value: SGSimpleSettings.shared.ghostMode, text: i18n("Settings.GhostMode.Active", lang), enabled: true))
    entries.append(.notice(id: id.count, section: .ghostMode, text: i18n("Settings.GhostMode.Notice", lang)))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeSendReadMessages, value: SGSimpleSettings.shared.ghostModeSendReadMessages, text: i18n("Settings.GhostMode.SendReadMessages", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeSendReadStories, value: SGSimpleSettings.shared.ghostModeSendReadStories, text: i18n("Settings.GhostMode.SendReadStories", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeSendOnlinePackets, value: SGSimpleSettings.shared.ghostModeSendOnlinePackets, text: i18n("Settings.GhostMode.SendOnlinePackets", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeSendUploadProgress, value: SGSimpleSettings.shared.ghostModeSendUploadProgress, text: i18n("Settings.GhostMode.SendUploadProgress", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeSendOfflinePacketAfterOnline, value: SGSimpleSettings.shared.ghostModeSendOfflinePacketAfterOnline, text: i18n("Settings.GhostMode.SendOfflinePacketAfterOnline", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeMarkReadAfterAction, value: SGSimpleSettings.shared.ghostModeMarkReadAfterAction, text: i18n("Settings.GhostMode.MarkReadAfterAction", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeUseScheduledMessages, value: SGSimpleSettings.shared.ghostModeUseScheduledMessages, text: i18n("Settings.GhostMode.UseScheduledMessages", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.oneFromManySelector(id: id.count, section: .ghostMode, settingName: .ghostModeSendWithoutSound, text: i18n("Settings.GhostMode.SendWithoutSound", lang), value: i18n("Settings.GhostMode.SendWithoutSound.\(SGSimpleSettings.shared.ghostModeSendWithoutSound)", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeSuggestBeforeStory, value: SGSimpleSettings.shared.ghostModeSuggestBeforeStory, text: i18n("Settings.GhostMode.SuggestBeforeStory", lang), enabled: SGSimpleSettings.shared.ghostMode))
    entries.append(.toggle(id: id.count, section: .ghostMode, settingName: .ghostModeLocked, value: SGSimpleSettings.shared.ghostModeLocked, text: i18n("Settings.GhostMode.Locked", lang), enabled: true))
    entries.append(.notice(id: id.count, section: .ghostMode, text: i18n("Settings.GhostMode.Locked.Notice", lang)))

    // MARK: Swiftgram — spy (AyuGram: SpyMessageRead / SpyMessageContentsRead)
    entries.append(.header(id: id.count, section: .spy, text: i18n("Settings.Spy.Header", lang), badge: nil))
    entries.append(.toggle(id: id.count, section: .spy, settingName: .spyMessageRead, value: SGSimpleSettings.shared.spyMessageRead, text: i18n("Settings.Spy.MessageRead", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .spy, settingName: .spyMessageContentsRead, value: SGSimpleSettings.shared.spyMessageContentsRead, text: i18n("Settings.Spy.MessageContentsRead", lang), enabled: true))
    entries.append(.notice(id: id.count, section: .spy, text: i18n("Settings.Spy.Notice", lang)))

    // MARK: Swiftgram — message shot (AyuGram: MessageShotSettings, ayu_settings.h:184-235)
    entries.append(.header(id: id.count, section: .messageShot, text: i18n("Settings.MessageShot.Header", lang), badge: nil))
    entries.append(.toggle(id: id.count, section: .messageShot, settingName: .showMessageShot, value: SGSimpleSettings.shared.showMessageShot, text: i18n("Settings.MessageShot.ShowMessageShot", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .messageShot, settingName: .messageShotShowBackground, value: SGSimpleSettings.shared.messageShotShowBackground, text: i18n("Settings.MessageShot.ShowBackground", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .messageShot, settingName: .messageShotShowDate, value: SGSimpleSettings.shared.messageShotShowDate, text: i18n("Settings.MessageShot.ShowDate", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .messageShot, settingName: .messageShotShowReactions, value: SGSimpleSettings.shared.messageShotShowReactions, text: i18n("Settings.MessageShot.ShowReactions", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .messageShot, settingName: .messageShotShowHeaderDecorations, value: SGSimpleSettings.shared.messageShotShowHeaderDecorations, text: i18n("Settings.MessageShot.ShowHeaderDecorations", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .messageShot, settingName: .messageShotShowColorfulReplies, value: SGSimpleSettings.shared.messageShotShowColorfulReplies, text: i18n("Settings.MessageShot.ShowColorfulReplies", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .messageShot, settingName: .messageShotRevealSpoilers, value: SGSimpleSettings.shared.messageShotRevealSpoilers, text: i18n("Settings.MessageShot.RevealSpoilers", lang), enabled: true))
    entries.append(.notice(id: id.count, section: .messageShot, text: i18n("Settings.MessageShot.Notice", lang)))

    // MARK: Swiftgram — streamer mode (AyuGram: ayu_settings.h:331-333, 355)
    entries.append(.header(id: id.count, section: .streamerMode, text: i18n("Settings.StreamerMode.Header", lang), badge: nil))
    entries.append(.toggle(id: id.count, section: .streamerMode, settingName: .streamerMode, value: SGSimpleSettings.shared.streamerMode, text: i18n("Settings.StreamerMode.Active", lang), enabled: true))
    entries.append(.notice(id: id.count, section: .streamerMode, text: i18n("Settings.StreamerMode.Notice", lang)))

    // MARK: Swiftgram — regex filters (AyuGram: ayu_settings.h:273-275, filters_controller.cpp)
    entries.append(.header(id: id.count, section: .filters, text: i18n("Settings.Filters.Header", lang), badge: nil))
    entries.append(.toggle(id: id.count, section: .filters, settingName: .filtersEnabled, value: SGSimpleSettings.shared.filtersEnabled, text: i18n("Settings.Filters.Active", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .filters, settingName: .filtersEnabledInChats, value: SGSimpleSettings.shared.filtersEnabledInChats, text: i18n("Settings.Filters.InChats", lang), enabled: true))
    entries.append(.toggle(id: id.count, section: .filters, settingName: .hideFromBlocked, value: SGSimpleSettings.shared.hideFromBlocked, text: i18n("Settings.Filters.HideFromBlocked", lang), enabled: true))
    entries.append(.notice(id: id.count, section: .filters, text: i18n("Settings.Filters.Notice", lang)))
...
//    }
    ...
    let arguments = SGItemListArguments<SGBoolSetting, SGSliderSetting, SGOneFromManySetting, SGDisclosureLink, AnyHashable>(
        ...
        // MARK: Swiftgram — ghost mode
        case .ghostMode:
            SGSimpleSettings.shared.setGhostModeEnabled(value)
            simplePromise.set(true) // Trigger update for 'enabled' field of other toggles
        case .ghostModeLocked:
            SGSimpleSettings.shared.ghostModeLocked = value
        case .ghostModeSendReadMessages:
            SGSimpleSettings.shared.ghostModeSendReadMessages = value
        case .ghostModeSendReadStories:
            SGSimpleSettings.shared.ghostModeSendReadStories = value
        case .ghostModeSendOnlinePackets:
            SGSimpleSettings.shared.ghostModeSendOnlinePackets = value
        case .ghostModeSendUploadProgress:
            SGSimpleSettings.shared.ghostModeSendUploadProgress = value
        case .ghostModeSendOfflinePacketAfterOnline:
            SGSimpleSettings.shared.ghostModeSendOfflinePacketAfterOnline = value
        case .ghostModeMarkReadAfterAction:
            SGSimpleSettings.shared.ghostModeMarkReadAfterAction = value
        case .ghostModeUseScheduledMessages:
            SGSimpleSettings.shared.ghostModeUseScheduledMessages = value
        case .ghostModeSuggestBeforeStory:
            SGSimpleSettings.shared.ghostModeSuggestBeforeStory = value
        case .spyMessageRead:
            SGSimpleSettings.shared.spyMessageRead = value
        case .spyMessageContentsRead:
            SGSimpleSettings.shared.spyMessageContentsRead = value
        case .showMessageShot:
            SGSimpleSettings.shared.showMessageShot = value
        case .messageShotShowBackground:
            SGSimpleSettings.shared.messageShotShowBackground = value
        case .messageShotShowDate:
            SGSimpleSettings.shared.messageShotShowDate = value
        case .messageShotShowReactions:
            SGSimpleSettings.shared.messageShotShowReactions = value
        case .messageShotShowHeaderDecorations:
            SGSimpleSettings.shared.messageShotShowHeaderDecorations = value
        case .messageShotShowColorfulReplies:
            SGSimpleSettings.shared.messageShotShowColorfulReplies = value
        case .messageShotRevealSpoilers:
            SGSimpleSettings.shared.messageShotRevealSpoilers = value
        case .streamerMode:
            SGSimpleSettings.shared.streamerMode = value
        case .showStreamerToggleInDrawer:
            SGSimpleSettings.shared.showStreamerToggleInDrawer = value
        case .showStreamerToggleInTray:
            SGSimpleSettings.shared.showStreamerToggleInTray = value
        case .filtersEnabled:
            SGSimpleSettings.shared.filtersEnabled = value
        case .filtersEnabledInChats:
            SGSimpleSettings.shared.filtersEnabledInChats = value
        case .hideFromBlocked:
            SGSimpleSettings.shared.hideFromBlocked = value
        case .disableSwipeToRecordStory:
...
//            }
            ...
            case .ghostModeSendWithoutSound:
                let setAction: (String) -> Void = { value in
                    SGSimpleSettings.shared.ghostModeSendWithoutSound = value
                    simplePromise.set(true)
                }

                for value in SGSimpleSettings.GhostModeSendWithoutSound.allCases {
                    items.append(ActionSheetButtonItem(title: i18n("Settings.GhostMode.SendWithoutSound.\(value.rawValue)", presentationData.strings.baseLanguageCode), color: .accent, action: { [weak actionSheet] in
                        actionSheet?.dismissAnimated()
                        setAction(value.rawValue)
                    }))
                }
