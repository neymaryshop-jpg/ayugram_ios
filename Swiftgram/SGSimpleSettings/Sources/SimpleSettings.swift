...
//        case allChatsFolderPositionOverride
        ...
        case ghostModeDisableOnStoryClose
        ...
        case deletedMark
        case editedMark
        // MARK: Swiftgram — spy (AyuGram: SpyMessageRead / SpyMessageContentsRead, entities.h:119-137)
        case spyMessageRead
        ...
        // MARK: Swiftgram — regex filters (AyuGram: ayu_settings.h:273-275, 631-633)
        case filtersEnabled
        case filtersEnabledInChats
        case hideFromBlocked
        case regexFiltersData
    }
    ...
    // MARK: Swiftgram — ghost mode: вариант отправки без звука
    public enum GhostModeSendWithoutSound: String, CaseIterable {
        case never
        case inGhostMode
        case always
    }
...
//        Keys.allChatsFolderPositionOverride.rawValue: AllChatsFolderPositionOverride.none.rawValue
        ...
        // MARK: Swiftgram — ghost mode: дефолты зеркалят AyuGram (ayu_settings.h:163-178)
        Keys.ghostMode.rawValue: false,
        Keys.ghostModeLocked.rawValue: false,
        Keys.ghostModeSendReadMessages.rawValue: true,
        Keys.ghostModeSendReadStories.rawValue: true,
        Keys.ghostModeSendOnlinePackets.rawValue: true,
        Keys.ghostModeSendUploadProgress.rawValue: true,
        Keys.ghostModeSendOfflinePacketAfterOnline.rawValue: false,
        Keys.ghostModeMarkReadAfterAction.rawValue: true,
        Keys.ghostModeUseScheduledMessages.rawValue: false,
        Keys.ghostModeSendWithoutSound.rawValue: GhostModeSendWithoutSound.never.rawValue,
        Keys.ghostModeSuggestBeforeStory.rawValue: true,
        Keys.ghostModeDisableOnStoryClose.rawValue: false,
        // MARK: Swiftgram — anti-delete: дефолты зеркалят AyuGram (ayu_settings.h:627-658)
        Keys.saveDeletedMessages.rawValue: true,
        Keys.saveMessagesHistory.rawValue: true,
        Keys.saveForBots.rawValue: false,
        Keys.semiTransparentDeletedMessages.rawValue: false,
        Keys.deletedMark.rawValue: "🧹",
        Keys.editedMark.rawValue: "изменено",
        // MARK: Swiftgram — spy
        Keys.spyMessageRead.rawValue: true,
        Keys.spyMessageContentsRead.rawValue: true,
        // MARK: Swiftgram — message shot: дефолты зеркалят AyuGram (ayu_settings.h:184-235, 701)
        Keys.showMessageShot.rawValue: true,
        Keys.messageShotShowBackground.rawValue: true,
        Keys.messageShotShowDate.rawValue: false,
        Keys.messageShotShowReactions.rawValue: false,
        Keys.messageShotShowHeaderDecorations.rawValue: true,
        Keys.messageShotShowColorfulReplies.rawValue: true,
        Keys.messageShotRevealSpoilers.rawValue: true,
        // MARK: Swiftgram — streamer mode: дефолты зеркалят AyuGram (ayu_settings.h:688-713)
        Keys.streamerMode.rawValue: false,
        Keys.showStreamerToggleInDrawer.rawValue: false,
        Keys.showStreamerToggleInTray.rawValue: false,
        // MARK: Swiftgram — regex filters: дефолты зеркалят AyuGram (ayu_settings.h:631-633)
        Keys.filtersEnabled.rawValue: false,
        Keys.filtersEnabledInChats.rawValue: false,
        Keys.hideFromBlocked.rawValue: false,
        Keys.regexFiltersData.rawValue: Data()
    ]
...
//    public var allChatsFolderPositionOverride: String
    ...
    @UserDefault(key: Keys.ghostModeLocked.rawValue)
    public var ghostModeLocked: Bool

    @UserDefault(key: Keys.ghostModeSendReadMessages.rawValue)
    public var ghostModeSendReadMessages: Bool

    @UserDefault(key: Keys.ghostModeSendReadStories.rawValue)
    public var ghostModeSendReadStories: Bool

    @UserDefault(key: Keys.ghostModeSendOnlinePackets.rawValue)
    public var ghostModeSendOnlinePackets: Bool

    @UserDefault(key: Keys.ghostModeSendUploadProgress.rawValue)
    public var ghostModeSendUploadProgress: Bool

    @UserDefault(key: Keys.ghostModeSendOfflinePacketAfterOnline.rawValue)
    public var ghostModeSendOfflinePacketAfterOnline: Bool

    @UserDefault(key: Keys.ghostModeMarkReadAfterAction.rawValue)
    public var ghostModeMarkReadAfterAction: Bool

    @UserDefault(key: Keys.ghostModeUseScheduledMessages.rawValue)
    public var ghostModeUseScheduledMessages: Bool

    @UserDefault(key: Keys.ghostModeSendWithoutSound.rawValue)
    public var ghostModeSendWithoutSound: String

    @UserDefault(key: Keys.ghostModeSuggestBeforeStory.rawValue)
    public var ghostModeSuggestBeforeStory: Bool
...
extension SGSimpleSettings {
    ...
    @UserDefault(key: Keys.saveMessagesHistory.rawValue)
    public var saveMessagesHistory: Bool

    @UserDefault(key: Keys.saveForBots.rawValue)
    public var saveForBots: Bool

    @UserDefault(key: Keys.semiTransparentDeletedMessages.rawValue)
    public var semiTransparentDeletedMessages: Bool

    @UserDefault(key: Keys.deletedMark.rawValue)
    ...
    public var spyMessageRead: Bool

    @UserDefault(key: Keys.spyMessageContentsRead.rawValue)
    public var spyMessageContentsRead: Bool

    // MARK: Swiftgram — message shot
    @UserDefault(key: Keys.showMessageShot.rawValue)
    public var showMessageShot: Bool

    @UserDefault(key: Keys.messageShotShowBackground.rawValue)
    public var messageShotShowBackground: Bool

    @UserDefault(key: Keys.messageShotShowDate.rawValue)
    public var messageShotShowDate: Bool

    @UserDefault(key: Keys.messageShotShowReactions.rawValue)
    public var messageShotShowReactions: Bool

    @UserDefault(key: Keys.messageShotShowHeaderDecorations.rawValue)
    public var messageShotShowHeaderDecorations: Bool

    @UserDefault(key: Keys.messageShotShowColorfulReplies.rawValue)
    public var messageShotShowColorfulReplies: Bool

    @UserDefault(key: Keys.messageShotRevealSpoilers.rawValue)
    public var messageShotRevealSpoilers: Bool

    // MARK: Swiftgram — streamer mode
    @UserDefault(key: Keys.streamerMode.rawValue)
    public var streamerMode: Bool

    @UserDefault(key: Keys.showStreamerToggleInDrawer.rawValue)
    public var showStreamerToggleInDrawer: Bool

    @UserDefault(key: Keys.showStreamerToggleInTray.rawValue)
    public var showStreamerToggleInTray: Bool

    // MARK: Swiftgram — regex filters

    @UserDefault(key: Keys.filtersEnabled.rawValue)
    public var filtersEnabled: Bool

    @UserDefault(key: Keys.filtersEnabledInChats.rawValue)
    public var filtersEnabledInChats: Bool

    @UserDefault(key: Keys.hideFromBlocked.rawValue)
    ...
    public var regexFilters: [SGRegexFilter] {
        get {
            guard let decoded = try? JSONDecoder().decode([SGRegexFilter].self, from: self.regexFiltersData) else {
                return []
            }
            return decoded
        }
        set {
            self.regexFiltersData = (try? JSONEncoder().encode(newValue)) ?? Data()
            SGFilterEngine.shared.invalidate()
        }
    }
