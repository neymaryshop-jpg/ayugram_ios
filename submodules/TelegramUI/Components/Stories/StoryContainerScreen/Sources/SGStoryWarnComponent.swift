                ...
                component: AnyComponent(
                    MultilineTextComponent(
                        text: .plain(NSAttributedString(
                            string: component.title ?? i18n("Stories.Warning.ViewStory", component.strings.baseLanguageCode),
            ...
            let textSize = self.descriptionLabel.update(
                ...
                component: AnyComponent(
                    BalancedTextComponent(
                        text: .plain(NSAttributedString(
                            string: component.description ?? i18n(component.isInStealthMode ? "Stories.Warning.NoticeStealth" : "Stories.Warning.Notice", component.strings.baseLanguageCode, authorName),
                ...
                component: AnyComponent(
                    ButtonComponent(
                        ...
                        content: AnyComponentWithIdentity(
                            id: component.actionTitle ?? component.strings.Chat_StoryMentionAction,
                            component: AnyComponent(ButtonTextContentComponent(
                                text: component.actionTitle ?? component.strings.Chat_StoryMentionAction,
                                badge: 0,
